...
function exercici1() {
    ...
    */
    let input1 = Number(document.getElementById("camp1").value);
    let input2 = Number(document.getElementById("camp2").value);
    if (input1 < input2) {
        let sol = input1 + input2;
        alert(sol);
    }
    else if (input1 > input2) {
        let sol2 = input1 / input2;
        console.log(sol2);
    }
    else {
...
function exercici2() {
   ...
   */
    let quantitatIntents = Number(document.getElementById("camp1").value);
    let segonNum = Number(document.getElementById("camp2").value);
    var notDiv = 0;
    for (let i = 0; i < quantitatIntents; i++) {
...
function exercici3() {
    ...
    */
    let codiColor = Number(document.getElementById("camp1").value);
    let mesuraPixels = Number(document.getElementById("camp2").value);
    if (codiColor % 2 == 0) {
